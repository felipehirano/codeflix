...
import { InMemorySearchableRepositoryInterface } from "../in-memory-repository";
...
class StubInMemorySearchableRepository extends InMemorySearchableRepositoryInterface<StubEntity>{
...
describe('InMemorySearchableRepository Unit Tests', () => {
    ...
    describe('applyFilter method', () => {
        it('should no filter items when filter param is null', async () => {
            ...
            // Por ser um método protected utilizo a notacao respository['applyFIlter']
