...
describe('Category Integration Tests', () => {
    describe('create method', () => {
        ...
        it('should a valid category', () => {
            // Indica que não é necessário utilizar o método expect, só testaremos as chamadas da classe, no caso o construtor
            expect.assertions(0);
    ...
    describe('update method', () => {
        ...
        it('should a invalid category using description property', () => {
            const category = new Category({name: 'Movie'});
            expect(() => category.update('Film', 5 as any)).containsErrorMessages(
                {
                    description:[
                        'description must be a string',
                    ]
        ...
        it('should a valid category', () => {
            // Indica que não é necessário utilizar o método expect, só testaremos as chamadas da classe, no caso o update
            expect.assertions(0);
            const category = new Category({ name: "Movie" });
